...
export function OrderDiscountMenu({ discounts, selectedId, onSelect }: Props) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="icon-sm"
          aria-label={selectedId === null ? "Apply order discount" : "Change order discount"}
          title={selectedId === null ? "Apply order discount" : "Change order discount"}
      ...
      <DropdownMenuContent align="end" className="min-w-52">
        <DropdownMenuLabel>Order discount</DropdownMenuLabel>
        <DropdownMenuSeparator />
