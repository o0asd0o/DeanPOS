...
import { handler as getPaymentMethodPaymentDetailsHandler } from "backend/src/payment-method/handlers/get-payment-method-payment-details.ts";
...
export const paymentMethodGetPaymentDetailsRoute = os.paymentMethod.getPaymentDetails.handler(
  ({ context, input }) => getPaymentMethodPaymentDetailsHandler({ ctx: context, input }),
);
