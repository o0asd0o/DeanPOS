...
import {
  ...
  catalogArchiveModifierGroupRoute,
  catalogArchiveModifierRoute,
  catalogArchiveVariantRoute,
  catalogArchiveAddOnRoute,
  catalogArchiveDiscountRoute,
  catalogCreateCategoryRoute,
  catalogCreateMenuItemRoute,
  catalogCreateModifierGroupRoute,
  catalogCreateModifierRoute,
  catalogCreateVariantRoute,
  catalogCreateAddOnRoute,
  catalogCreateDiscountRoute,
  catalogGetMenuItemRoute,
  catalogGetVariantRoute,
  catalogListCategoriesRoute,
  catalogListMenuItemsRoute,
  catalogListModifierGroupsRoute,
  catalogListModifiersRoute,
  catalogListVariantsRoute,
  catalogListAddOnsRoute,
  catalogListDiscountsRoute,
  catalogMoveMenuItemRoute,
  catalogSetMenuItemPriceRoute,
  catalogReadRoute,
  catalogReactivateCategoryRoute,
  catalogReactivateMenuItemRoute,
  catalogReactivateModifierGroupRoute,
  catalogReactivateModifierRoute,
  catalogReactivateVariantRoute,
  catalogReactivateAddOnRoute,
  catalogReactivateDiscountRoute,
  catalogRenameCategoryRoute,
  catalogRenameMenuItemRoute,
  catalogRenameVariantRoute,
  catalogReorderCategoryRoute,
  catalogReorderMenuItemRoute,
  catalogReorderModifierGroupRoute,
  catalogReorderModifierRoute,
  catalogReorderVariantRoute,
  catalogReorderAddOnRoute,
  catalogSetVariantPriceRoute,
  catalogUpdateModifierGroupRoute,
  catalogUpdateModifierRoute,
  catalogUpdateAddOnRoute,
  catalogUpdateDiscountRoute,
  catalogVersionRoute,
  catalogLinkModifierGroupToMenuItemRoute,
  catalogUnlinkModifierGroupFromMenuItemRoute,
  catalogListLinkedModifierGroupsForMenuItemRoute,
  catalogLinkAddOnToMenuItemRoute,
  catalogUnlinkAddOnFromMenuItemRoute,
  catalogListLinkedAddOnsForMenuItemRoute,
...
import { terminalReceiptRoute, terminalSubmitOrderRoute } from "./routes/terminal-order.ts";
  ...
  const router = implement(contract)
    ...
    .router({
      ...
      catalog: {
        ...
        getMenuItem: catalogGetMenuItemRoute,
        listVariants: catalogListVariantsRoute,
        getVariant: catalogGetVariantRoute,
        ...
        setMenuItemPrice: catalogSetMenuItemPriceRoute,
        ...
        createVariant: catalogCreateVariantRoute,
        renameVariant: catalogRenameVariantRoute,
        setVariantPrice: catalogSetVariantPriceRoute,
        archiveVariant: catalogArchiveVariantRoute,
        reactivateVariant: catalogReactivateVariantRoute,
        reorderVariant: catalogReorderVariantRoute,
        listModifierGroups: catalogListModifierGroupsRoute,
        createModifierGroup: catalogCreateModifierGroupRoute,
        updateModifierGroup: catalogUpdateModifierGroupRoute,
        archiveModifierGroup: catalogArchiveModifierGroupRoute,
        reactivateModifierGroup: catalogReactivateModifierGroupRoute,
        reorderModifierGroup: catalogReorderModifierGroupRoute,
        listModifiers: catalogListModifiersRoute,
        createModifier: catalogCreateModifierRoute,
        updateModifier: catalogUpdateModifierRoute,
        archiveModifier: catalogArchiveModifierRoute,
        ...
        archiveAddOn: catalogArchiveAddOnRoute,
        reactivateAddOn: catalogReactivateAddOnRoute,
        listDiscounts: catalogListDiscountsRoute,
        createDiscount: catalogCreateDiscountRoute,
        updateDiscount: catalogUpdateDiscountRoute,
        archiveDiscount: catalogArchiveDiscountRoute,
        reactivateDiscount: catalogReactivateDiscountRoute,
        reorderAddOn: catalogReorderAddOnRoute,
        linkAddOnToMenuItem: catalogLinkAddOnToMenuItemRoute,
        unlinkAddOnFromMenuItem: catalogUnlinkAddOnFromMenuItemRoute,
        listLinkedAddOnsForMenuItem: catalogListLinkedAddOnsForMenuItemRoute,
