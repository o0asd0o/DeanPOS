...
import {
  ...
  catalogLinkModifierGroupRoute,
  catalogListCategoriesRoute,
  catalogListLinkedModifierGroupsRoute,
  ...
  catalogUnlinkModifierGroupRoute,
  ...
  const router = implement(contract)
    ...
    .router({
      ...
      catalog: {
        ...
        linkModifierGroup: catalogLinkModifierGroupRoute,
        unlinkModifierGroup: catalogUnlinkModifierGroupRoute,
        listLinkedModifierGroups: catalogListLinkedModifierGroupsRoute,
